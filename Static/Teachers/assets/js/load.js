...
function typeof_paper(){
    var Assignment = document.getElementsByClassName("Assignment")[0];
 ...
 document.getElementsByClassName("papertype")[0].addEventListener("click",(event)=>{
         ...
         if(type_paper[1]=='Assignment'){
             Assignment.style.display='flex';
         }
         else if(type_paper[1]=='MCQS'){
             MCQS.style.display='flex';
         }
         else if(type_paper[1]=='Subjective'){
             Subjective.style.display='flex';
         }
         else if(type_paper[1]=='Quiz'){
             Quiz.style.display='flex';
         }
         else if(type_paper[1]=='Exam'){

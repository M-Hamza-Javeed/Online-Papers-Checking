    ...
    for line in data:
        ...
        for mistake in matches:
            try:
                ...
                pass
        correct.append(line)
    return({"correct":correct,"len":len(correct),"error":i,"errortypes":list(set(errors))})
...
def simalarity(sent1,sent2):
    Word2Vec=0;jaccard=0;WordMover=0;doc_sim=0
    ...
    print({"Word2vec_sim":Word2Vec,"jaccard_sim":jaccard,
    "sent1":sent1_correct,"sen2":sent2_correct,
    "lingustic_features_sent1":{"NER":ling1[0],"NOUN":ling1[1],"VERB":ling1[2]},
    "lingustic_features_sent2":{"NER":ling2[0],"NOUN":ling2[1],"VERB":ling2[2]}})
